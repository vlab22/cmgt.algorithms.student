...
class AlgorithmsAssignment : Game
{
    ...
    private NodeLabelDrawer _nodeLabelDrawer = null;
    ...
    void ResetDungeon()
    {
        if (_dungeon != null) RemoveChild(_dungeon);
        if (_tiledView != null) RemoveChild(_tiledView);
        if (_pathFinder != null) RemoveChild(_pathFinder);
        if (_graph != null) RemoveChild(_graph);
        if (_nodeLabelDrawer != null) RemoveChild(_nodeLabelDrawer);
        if (_agent != null) RemoveChild(_agent);
